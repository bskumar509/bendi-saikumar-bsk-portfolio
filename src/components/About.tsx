        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Badge className="px-4 py-2 text-sm font-medium bg-blue-100 text-blue-800 hover:bg-blue-200">
                Fresh Graduate
              </Badge>
              <Badge className="px-4 py-2 text-sm font-medium bg-blue-100 text-blue-800 hover:bg-blue-200">
                Quick Learner
          ...
          <div className="grid gap-6">
            {highlights.map((highlight, index) => (
              <Card key={index} className="border-l-4 border-l-blue-500 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white/80 backdrop-blur-sm">
